<div class="wrapper">
    <div id="month-list" class="panel panel-default" data-ajax-tab="month_list">
        <div class="panel-heading">
            <div class="row">
                <div class="cell date col-xs-3">Date</div>
                <div class="cell title col-xs-6">Title</div>
                <div class="cell desc hidden-xs">Description</div>
                <div class="cell values col-xs-3">Value</div>
                <div class="cell actions hidden-xs">Actions</div>
            </div>
        </div>
